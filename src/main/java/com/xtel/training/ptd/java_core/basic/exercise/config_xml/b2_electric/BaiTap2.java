package com.xtel.training.ptd.java_core.basic.exercise.config_xml.b2_electric;

import com.xtel.training.ptd.common.utils.NumberUtils;
import com.xtel.training.ptd.common.utils.XMLUtils;
import com.xtel.training.ptd.java_core.basic.exercise.config_xml.b2_electric.model.ElectricBill;
...
public class BaiTap2 {
    ...
    public static void main(String[] args) {
        ...
        Integer electricNum = null;
        try {
            electricNum = NumberUtils.parseInt(SCANNER.nextLine());
        } catch (Exception e) {
            e.printStackTrace();
        }
